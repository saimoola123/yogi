			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FruitStore-display": {
								"semanticObject": "FruitStore",
								"action": "display",
								"description": "Demo Application for WebIDeFullStack Features",
								"title": "Fruit Store",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sai.moola.WIFSDemo",
									"url": sap.ui.require.toUrl("sai/moola/WIFSDemo")
								}
							}
						}
					}
